        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-xl animate-fade-in" onClick={closeModal}>
          ...
          >
            ...
            <div className="relative h-96">
              <img
                src={selectedCar.gallery[0] || selectedCar.primaryImage || '/placeholder-car.jpg'}
            ...
            <div className="p-8 md:p-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <a href="/virtual-tour" className="block">
                    ...
                    <a href="https://wa.me/60124134002" target="_blank" rel="noopener noreferrer" className="block">
